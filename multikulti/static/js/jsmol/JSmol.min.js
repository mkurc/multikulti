...
j.querySelectorAll(e)),b}catch(f){}finally{d||a.removeAttribute("id")}}}var g;a:{m=m.replace(Qa,"$1");h=Oa(m);if(!c&&1===h.length){d=h[0]=h[0].slice(0);if(2<d.length&&"ID"===(g=d[0]).type&&B.getById&&9===a.nodeType&&W&&w.relative[d[1].type]){a=(w.find.ID(g.matches[0].replace(ca,da),a)||[])[0];if(!a){g=b;break a}m=m.slice(d.shift().value.length)}for(l=Ra.needsContext.test(m)?0:d.length;l--;){g=d[l];if(w.relative[j=g.type])break;if(j=w.find[j])if(c=j(g.matches[0].replace(ca,da),rb.test(d[0].type)&&
sb(a.parentNode)||a)){d.splice(l,1);m=c.length&&Pa(d);if(!m){ba.apply(b,c);g=b;break a}break}}}tb(m,h)(c,a,!W,b,rb.test(m)&&sb(a.parentNode)||a);g=b}return g},ub=function(){function m(b,c){a.push(b+" ")>w.cacheLength&&delete m[a.shift()];return m[b+" "]=c}var a=[];return m},S=function(m){m[F]=!0;return m},T=function(m){var a=I.createElement("div");try{return!!m(a)}catch(b){return!1}finally{a.parentNode&&a.parentNode.removeChild(a)}},vb=function(a,b){for(var c=a.split("|"),d=a.length;d--;)w.attrHandle[c[d]]=
...
xb=function(a){return 1<a.length?function(b,c,d){for(var h=a.length;h--;)if(!a[h](b,c,d))return!1;return!0}:a[0]},Sa=function(a,b,c,d,h){for(var j,l=[],e=0,f=a.length,g=null!=b;e<f;e++)if(j=a[e])if(!c||c(j,d,h))l.push(j),g&&b.push(e);return l},yb=function(a,b,c,d,h,j){d&&!d[F]&&(d=yb(d));h&&!h[F]&&(h=yb(h,j));return S(function(j,l,e,f){var g,p,L=[],n=[],r=l.length,k;if(!(k=j)){k=b||"*";for(var t=e.nodeType?[e]:e,q=[],C=0,G=t.length;C<G;C++)y(k,t[C],q);k=q}k=a&&(j||!b)?Sa(k,L,a,e,f):k;t=c?h||(j?a:
r||d)?[]:l:k;c&&c(k,t,e,f);if(d){g=Sa(t,n);d(g,[],e,f);for(e=g.length;e--;)if(p=g[e])t[n[e]]=!(k[n[e]]=p)}if(j){if(h||a){if(h){g=[];for(e=t.length;e--;)if(p=t[e])g.push(k[e]=p);h(null,t=[],g,f)}for(e=t.length;e--;)if((p=t[e])&&-1<(g=h?na.call(j,p):L[e]))j[g]=!(l[g]=p)}}else t=Sa(t===l?t.splice(r,t.length):t),h?h(null,l,t,f):ba.apply(l,t)})},zb=function(a){var b,c,d,h=a.length,j=w.relative[a[0].type];c=j||w.relative[" "];for(var l=j?1:0,e=wb(function(a){return a===b},c,!0),f=wb(function(a){return-1<
na.call(b,a)},c,!0),g=[function(a,m,c){return!j&&(c||m!==Ta)||((b=m).nodeType?e(a,m,c):f(a,m,c))}];l<h;l++)if(c=w.relative[a[l].type])g=[wb(xb(g),c)];else{c=w.filter[a[l].type].apply(null,a[l].matches);if(c[F]){for(d=++l;d<h&&!w.relative[a[d].type];d++);return yb(1<l&&xb(g),1<l&&Pa(a.slice(0,l-1).concat({value:" "===a[l-2].type?"*":""})).replace(Qa,"$1"),c,l<d&&zb(a.slice(l,d)),d<h&&zb(a=a.slice(d)),d<h&&Pa(a))}g.push(c)}return xb(g)},va,B,w,Ua,oc,tb,Ta,ea,wa,aa,I,Y,W,N,oa,Va,Da,F="sizzle"+-new Date,
...
m){if(typeof m.getElementById!==ua&&W){var b=m.getElementById(a);return b&&b.parentNode?[b]:[]}},w.filter.ID=function(a){var m=a.replace(ca,da);return function(a){return a.getAttribute("id")===m}}):(delete w.find.ID,w.filter.ID=function(a){var m=a.replace(ca,da);return function(a){return(a=typeof a.getAttributeNode!==ua&&a.getAttributeNode("id"))&&a.value===m}});w.find.TAG=B.getElementsByTagName?function(a,m){if(typeof m.getElementsByTagName!==ua)return m.getElementsByTagName(a)}:function(a,m){var b,
c=[],d=0,v=m.getElementsByTagName(a);if("*"===a){for(;b=v[d++];)1===b.nodeType&&c.push(b);return c}return v};w.find.CLASS=B.getElementsByClassName&&function(a,m){if(typeof m.getElementsByClassName!==ua&&W)return m.getElementsByClassName(a)};oa=[];N=[];if(B.qsa=Ea.test(b.querySelectorAll))T(function(a){a.innerHTML="<select t=''><option selected=''></option></select>";a.querySelectorAll("[t^='']").length&&N.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||N.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
...
Va.call(a,"div");Va.call(a,"[s!='']:x");oa.push("!=",Bb)});N=N.length&&RegExp(N.join("|"));oa=oa.length&&RegExp(oa.join("|"));Da=(a=Ea.test(Y.compareDocumentPosition))||Ea.test(Y.contains)?function(a,m){var b=9===a.nodeType?a.documentElement:a,c=m&&m.parentNode;return a===c||!(!c||!(1===c.nodeType&&(b.contains?b.contains(c):a.compareDocumentPosition&&a.compareDocumentPosition(c)&16)))}:function(a,m){if(m)for(;m=m.parentNode;)if(m===a)return!0;return!1};Ab=a?function(a,m){if(a===m)return wa=!0,0;var c=
...
Jmol._version||(Jmol=function(b){var k=function(b){return{header:b++,rear:b++,main:b++,image:b++,front:b++,fileOpener:b++,coverImage:b++,dialog:b++,menu:b+9E4,console:b+91E3,monitorZIndex:b+99999}},k={_version:"$Date: 2014-10-05 20:16:30 -0500 (Sun, 05 Oct 2014) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_getZOrders:k,_z:k(Jmol.z||9E3),_debugCode:!0,db:{_databasePrefixes:"$=:",
...
_restReportUrl:"http://www.pdb.org/pdb/rest/customReport?pdbids=IDLIST&customReportColumns=structureId,structureTitle"},_debugAlert:!1,_document:b,_isXHTML:!1,_lastAppletID:null,_mousePageX:null,_mouseOwner:null,_serverUrl:"http://biocomp.chem.uw.edu.pl/jsmol.php",_syncId:(""+Math.random()).substring(3),_touching:!1,_XhtmlElement:null,_XhtmlAppendChild:!1};b=b.location.href.toLowerCase();k._httpProto=0==b.indexOf("https")?"https://":"http://";k._isFile=0==b.indexOf("file:");k._ajaxTestSite=k._httpProto+
"google.com";b=k._isFile||0==b.indexOf("http://localhost")||0==b.indexOf("http://127.");k._tracker="http://"==k._httpProto&&!b&&"http://chemapps.stolaf.edu/jmol/JmolTracker.htm?id=UA-45940799-1";k._isChrome=0<=navigator.userAgent.toLowerCase().indexOf("chrome");k._isSafari=!k._isChrome&&0<=navigator.userAgent.toLowerCase().indexOf("safari");k._isMsie=void 0!==window.ActiveXObject;k._useDataURI=!k._isSafari&&!k._isMsie;for(var f in Jmol)k[f]=Jmol[f];return k}(document,Jmol));
...
function(a){self.Clazz&&Clazz.setConsoleDiv(a)};b._registerApplet=function(a,c){return window[a]=b._applets[a]=b._applets[c]=b._applets[a+"__"+b._syncId+"__"]=c};b._readyCallback=function(a,c,d,e){a=a.split("_object")[0];d=d.booleanValue?d.booleanValue():d;b._track(b._applets[a])._readyCallback(a,c,d,e)};b._getWrapper=function(a,c){var d;if(c){var e="";a._coverImage&&(d=' onclick="Jmol.coverApplet(ID, false)" title="'+a._coverTitle+'"',e='<image id="ID_coverclickgo" src="'+a._j2sPath+'/img/play_make_live.jpg" style="width:25px;height:25px;position:absolute;bottom:10px;left:10px;z-index:'+
b._getZ(a,"coverImage")+';opacity:0.5;"'+d+" />",e='<div id="ID_coverdiv" style="background-color:red;z-index:'+b._getZ(a,"coverImage")+';width:100%;height:100%;display:inline;position:absolute;top:0px;left:0px"><image id="ID_coverimage" src="'+a._coverImage+'" style="width:100%;height:100%"'+d+"/>"+e+"</div>");d='...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left">IMG......<div id="ID_appletdiv" style="z-index:'+b._getZ(a,"header")+';width:100%;height:100%;position:absolute;top:0px;left:0px;">';
var f=a._height,l=a._width;if("string"!==typeof f||0>f.indexOf("%"))f+="px";if("string"!==typeof l||0>l.indexOf("%"))l+="px";d=d.replace(/IMG/,e).replace(/Hpx/g,f).replace(/Wpx/g,l)}else d='......</div>......<div id="ID_2dappletdiv" style="position:absolute;width:100%;height:100%;overflow:hidden;display:none"></div>......<div id="ID_infotablediv" style="width:100%;height:100%;position:absolute;top:0px;left:0px">.........<div id="ID_infoheaderdiv" style="height:20px;width:100%;background:yellow;display:none"><span id="ID_infoheaderspan"></span><span id="ID_infocheckboxspan" style="position:absolute;text-align:right;right:1px;"><a href="javascript:Jmol.showInfo(ID,false)">[x]</a></span></div>.........<div id="ID_infodiv" style="position:absolute;top:20px;bottom:0px;width:100%;height:100%;overflow:auto"></div>......</div>...</div>';
...
"checked",!!a.selected)};d.setSelectedIndex=function(a){b.$prop(a.id,"selectedIndex",a.selectedIndex)};d.setText=function(a){b.$prop(a.id,"value",a.text)};d.setVisible=function(a){b.$setVisible(a.id,a.visible)};d.setEnabled=function(a){b.$setEnabled(a.id,a.enabled)};d.click=function(a,c){var j=d.htDialogs[a.id];if(j){var e=j.toString();if(0<=e.indexOf("JCheck"))j.selected=a.checked;else if(0<=e.indexOf("JCombo"))j.selectedIndex=a.selectedIndex;else if(null!=j.text&&(j.text=a.value,c&&13!=(c.charCode||
c.keyCode)))return}e=d.htDialogs[b.$getAncestorDiv(a.id,"JDialog").id];e.manager.actionPerformed(j?j.name:e.registryKey+"/"+a.id)};d.setFront=function(a){var c=a.manager.vwr.html5Applet;a.zIndex!=b._getZ(c,"dialog")&&(a.zIndex=b._incrZ(c,"dialog"));a.container&&((a.container[0]||a.container).style.zIndex=a.zIndex)};d.hideMenus=function(a){if(a=a._menus)for(var b in a)a[b].visible&&d.hideMenu(a[b])};d.windowClosing=function(a){a=d.htDialogs[b.$getAncestorDiv(a.id,"JDialog").id];a.registryKey?a.manager.processWindowClosing(a.registryKey):
...
!1);g.addSelectionOptions&&(e+=b._getGrabberOptions(this));b._debugAlert&&!b._document&&alert(e);this._code=b._documentWrite(e)};k._cover=function(f){f||!this._deferApplet?this._displayCoverImage(f):(f=this._coverScript?this._coverScript:"",this._coverScript="",this._deferUncover&&(f+=";refresh;javascript "+this._id+"._displayCoverImage(false)"),this._script(f,!0),this._deferUncover&&"activate 3D model"==this._coverTitle&&(b._getElement(this,"coverimage").title="3D model is loading..."),this._isJava||
this._newCanvas(!1),this._defaultModel&&b._search(this,this._defaultModel),this._showInfo(!1),this._deferUncover||this._displayCoverImage(!1),this._isJava&&b.$html(b.$(this,"appletdiv"),this._javaCode),this._init&&this._init())};k._displayCoverImage=function(f){this._coverImage&&this._isCovered!=f&&(this._isCovered=f,b._getElement(this,"coverdiv").style.display=f?"block":"none")};k._newCanvas=function(b){this._is2D?this._createCanvas2d(b):this._GLmol.create()};k._createCanvas2d=function(){var f=b.$(this,
"appletdiv");try{f[0].removeChild(this._canvas),this._canvas.frontLayer&&f[0].removeChild(this._canvas.frontLayer),this._canvas.rearLayer&&f[0].removeChild(this._canvas.rearLayer),this._canvas.imageLayer&&f[0].removeChild(this._canvas.imageLayer),b._jsUnsetMouse(this._mouseInterface)}catch(g){}var e=Math.round(f.width()),n=Math.round(f.height()),k=document.createElement("canvas");k.applet=this;this._canvas=k;k.style.width="100%";k.style.height="100%";k.width=e;k.height=n;k.id=this._id+"_canvas2d";
f.append(k);b._$(k.id).css({"z-index":b._getZ(this,"main")});if(this._isLayered){var d=document.createElement("div");k.imageLayer=d;d.id=this._id+"_imagelayer";f.append(d);b._$(d.id).css({zIndex:b._getZ(this,"image"),position:"absolute",left:"0px",top:"0px",width:"0px",height:"0px",overflow:"hidden"});this._mouseInterface=this._getLayer("front",f,e,n,!1)}else this._mouseInterface=k;b._jsSetMouse(this._mouseInterface)};k._getLayer=function(f,g,e,n,k){var d=document.createElement("canvas");this._canvas[f+
"Layer"]=d;d.style.width="100%";d.style.height="100%";d.id=this._id+"_"+f+"Layer";d.width=e;d.height=n;g.append(d);d.applet=this;b._$(d.id).css({background:k?"rgb(0,0,0,1)":"rgb(0,0,0,0.001)","z-index":b._getZ(this,f),position:"absolute",left:"0px",top:"0px",overflow:"hidden"});return d};k._setupJS=function(){window["j2s.lib"]={base:this._j2sPath+"/",alias:".",console:this._console,monitorZIndex:b._getZ(this,"monitorZIndex")};0==b.__execStack.length&&b.__addExec([this,b.__loadClazz,null,"loadClazz"]);
this._isJSV?(b.__addCoreFile("jsv",this._j2sPath,this.__Info.preloadCore),b._debugCode&&(b.__addExec([this,b.__loadClass,"JSV.appletjs.JSVApplet","load JSV"]),this._isPro&&b.__addExec([this,b.__loadClass,"JSV.appletjs.JSVAppletPro","load JSV(signed)"]))):this._isAstex?(b.__addCoreFile("astex",this._j2sPath,this.__Info.preloadCore),b._debugCode&&b.__addExec([this,b.__loadClass,"astex.MoleculeViewerAppletJS","load Astex"])):(b.__addCoreFile("jmol",this._j2sPath,this.__Info.preloadCore),this._is2D||
b.__addExec([this,b.__loadClass,"J.export.JSExporter","load JSExporter"]),b._debugCode&&b.__addExec([this,b.__loadClass,"J.appletjs.Jmol","load Jmol"]));b.__addExec([this,this.__startAppletJS,null,"start applet"]);this._isSigned=!0;this._ready=!1;this._applet=null;this._canScript=function(){return!0};this._savedOrientations=[];b.__execTimer&&clearTimeout(b.__execTimer);b.__execTimer=setTimeout(b.__nextExecution,b.__execDelayMS)};k.__startAppletJS=function(f){0==b._version.indexOf("$Date: ")&&(b._version=
(b._version.substring(7)+" -").split(" -")[0]+" (JSmol/j2s)");var g=Clazz._4Name("java.util.Hashtable").newInstance();b._setAppletParams(f._availableParams,g,f.__Info,!0);g.put("appletReadyCallback","Jmol._readyCallback");g.put("applet",!0);g.put("name",f._id);g.put("syncId",b._syncId);b._isAsync&&g.put("async",!0);f._color&&g.put("bgcolor",f._color);f._is2D?f._startupScript&&g.put("script",f._startupScript):g.put("script","set multipleBondSpacing 0.35;");b._syncedApplets.length&&g.put("synccallback",
"Jmol._mySyncCallback");g.put("signedApplet","true");g.put("platform",f._platform);f._is2D&&g.put("display",f._id+"_canvas2d");g.put("documentBase",document.location.href);var e=f._j2sPath+"/";if(0>e.indexOf("://")){var n=document.location.href.split("#")[0].split("?")[0].split("/");0==e.indexOf("/")?n=[n[0],e.substring(1)]:n[n.length-1]=e;e=n.join("/")}g.put("codePath",e);b._registerApplet(f._id,f);try{f._newApplet(g)}catch(k){System.out.println((b._isAsync?"normal async abort from ":"")+k);return}f._jsSetScreenDimensions();
b.__nextExecution()};k._restoreState=function(f,g){System.out.println("\n\nasynchronous restore state for "+f+" "+g);var e=this,n=e._applet&&e._applet.viewer;switch(g){case "setOptions":return function(){e.__startAppletJS(e)};case "render":return function(){setTimeout(function(){n.refresh(2)},10)};default:switch(f){case "J.shape.Balls":case "J.shape.Sticks":case "J.shape.Frank":return null}if(n&&n.isScriptExecuting&&n.isScriptExecuting()){if(b._asyncCallbacks[f])return System.out.println("...ignored"),
1;var k=n.getEvalContextAndHoldQueue(n.eval),d=k.pc-1;k.asyncID=f;b._asyncCallbacks[f]=function(a){k.pc=a;System.out.println("sc.asyncID="+k.asyncID+" sc.pc = "+k.pc);n.eval.resumeEval(k)};n.eval.pc=n.eval.pcEnd;System.out.println("setting resume for pc="+k.pc+" "+f+" to "+b._asyncCallbacks[f]+"//");return function(){System.out.println("resuming "+f+" "+b._asyncCallbacks[f]);b._asyncCallbacks[f](d)}}System.out.println(f+"?????????????????????"+g);return function(){setTimeout(function(){n.refresh(2)},
10)}}};k._jsSetScreenDimensions=function(){if(this._applet){var f=b._getElement(this,this._is2D?"canvas2d":"canvas");this._applet.setScreenDimension(f.width,f.height)}};k._show=function(f){b.$setVisible(b.$(this,"appletdiv"),f);f&&b._repaint(this,!0)};k._canScript=function(){return!0};k._delay=function(b,g,e){this._delayID=setTimeout(function(){b.resumeEval(g,!1)},e)};k._createDomNode=function(b,g){b=this._id+"_"+b;var e=document.getElementById(b);e&&document.body.removeChild(e);if(g){0==g.indexOf("<?")&&
(g=g.substring(g.indexOf("<",1)));if(0<=g.indexOf("/>")){for(var e=g.split("/>"),n=e.length-1;0<=--n;)for(var k=e[n],d=k.lastIndexOf("<")+1,a=d,c=k.length,j="";++a<c;)if(0<=" \t\n\r".indexOf(k.charAt(a))){j=k.substring(d,a);e[n]=k+"></"+j+">";break}g=e.join("")}e=document.createElement("_xml");e.id=b;e.innerHTML=g;e.style.display="none";document.body.appendChild(e);return e}};k.equals=function(b){return this==b};k.clone=function(){return this};k.hashCode=function(){return parseInt(this._uniqueId)};
k._processGesture=function(b){return this._applet.processTwoPointGesture(b)};k._processEvent=function(b,g){this._applet.processMouseEvent(b,g[0],g[1],g[2],System.currentTimeMillis())};k._resize=function(){var f="__resizeTimeout_"+this._id;b[f]&&clearTimeout(b[f]);var g=this;b[f]=setTimeout(function(){b._repaint(g,!0);b[f]=null},100)};return k};b._repaint=function(k,f){if(k&&k._applet){var g=b.$(k,"appletdiv"),e=Math.round(g.width()),g=Math.round(g.height());if(k._is2D&&(k._canvas.width!=e||k._canvas.height!=
g))k._newCanvas(!0),k._applet.setDisplay(k._canvas);k._applet.setScreenDimension(e,g);f?setTimeout(function(){k._applet&&k._applet.update()}):k._applet.update()}};b._getHiddenCanvas=function(b,f,g,e,n){f=b._id+"_"+f;(b=document.getElementById(f))&&n&&(b=null);b||(b=document.createElement("canvas"));b.width=b.style.width=g;b.height=b.style.height=e;b.id!=f&&(b.id=f);return b};b._loadImage=function(k,f,g,e,n){var q=f[1];if(null==n)return n=new Image,n.onload=function(){b._loadImage(k,f,null,e,n)},null!=
g&&(g=J.io.Base64.getBase64(g).toString(),g=q.substring(url.lastIndexOf("/")+1),0<=g.indexOf(".png")||g.indexOf(".jpg")),n.src=q,!0;g=n.width;var d=n.height,a="echo_"+f[0],c=b._getHiddenCanvas(k.vwr.html5Applet,a,g,d,!0);c.imageWidth=g;c.imageHeight=d;c.id=a;c.image=n;b._setCanvasImage(c,g,d);e(c,q)};b._setCanvasImage=function(b,f,g){b.buf32=null;b.width=f;b.height=g;b.getContext("2d").drawImage(b.image,0,0,f,g)}})(Jmol);
...
this._isCovered&&this._deferApplet};g._checkDeferred=function(b){return this._isDeferred()?(this._coverScript=b,this._cover(!1),!0):!1};g._getSmiles=function(){return this._evaluate("{visible}.find('SMILES')")};g._getMol=function(){return this._evaluate("getProperty('ExtractModel',{visible})")};g._getMol2D=function(){return jmol._evaluate("script('select visible;show chemical sdf')")};b.jmolSmiles=function(b){return b._getSmiles()}})(Jmol,document);
...
g,e,k,q,d,a,c)};b.jmolRadioGroup=function(f,g,e,k,q,d){return b.controls._getRadioGroup(f,g,e,k,q,d)};b.setCheckboxGroup=function(f,g){b.controls._cbSetCheckboxGroup(f,g,arguments)};b.setDocument=function(f){b._document=f};b.setXHTML=function(f){b._isXHTML=!0;b._XhtmlElement=null;b._XhtmlAppendChild=!1;f&&(b._XhtmlElement=document.getElementById(f),b._XhtmlAppendChild=!0)};b.setAppletCss=function(f,g){null!=f&&(b.controls._appletCssClass=f);b.controls._appletCssText=g?g+" ":f?'class="'+f+'" ':""};
b.setButtonCss=function(f,g){null!=f&&(b.controls._buttonCssClass=f);b.controls._buttonCssText=g?g+" ":f?'class="'+f+'" ':""};b.setCheckboxCss=function(f,g){null!=f&&(b.controls._checkboxCssClass=f);b.controls._checkboxCssText=g?g+" ":f?'class="'+f+'" ':""};b.setRadioCss=function(f,g){null!=f&&(b.controls._radioCssClass=f);b.controls._radioCssText=g?g+" ":f?'class="'+f+'" ':""};b.setLinkCss=function(f,g){null!=f&&(b.controls._linkCssClass=f);b.controls._linkCssText=g?g+" ":f?'class="'+f+'" ':""};
b.setMenuCss=function(f,g){null!=f&&(b.controls._menuCssClass=f);b.controls._menuCssText=g?g+" ":f?'class="'+f+'" ':""};b.setAppletSync=function(f,g,e){b._syncedApplets=f;b._syncedCommands=g;b._syncedReady={};b._isJmolJSVSync=e};b.setGrabberOptions=function(f){b._grabberOptions=f};b.setAppletHtml=function(f,g){f._code&&(b.$html(g,f._code),f._init&&!f._deferApplet&&f._init())};b.coverApplet=function(b,g){b._cover&&b._cover(g)};b.setFileCaching=function(f,g){f?f._cacheFiles=g:b.fileCache=g?{}:null};
b.updateView=function(b,g,e){b._updateView(g,e)};b.getChemicalInfo=function(f,g,e){g||(g="name");"string"!=typeof applet_or_Identifier&&(f=f._getSmiles());return b._getNCIInfo(f,g,e)};b.saveImage=function(b){switch(b._viewType){case "Jmol":b._script('write PNGJ "'+b._id+'.png"');break;case "JSV":b._script("write PDF");break;case "JME":b._script("print")}}})(Jmol);
...
"red")};q.err.println=function(b){n.consoleOutput("undefined"==typeof b?"\r\n":null==b?"null\r\n":b+"\r\n","red")};q.err.write=function(b,a,c){q.err.print(String.instantialize(b).substring(a,a+c))}}(Clazz))};Jmol.___JmolDate="$Date: 2014-10-13 19:33:47 -0500 (Mon, 13 Oct 2014) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.2.7_2014.10.13";
